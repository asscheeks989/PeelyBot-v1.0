...
with open('info.json') as f:
    try:
        ...
        print(Fore.RED + ' [ERROR] ' + Fore.RESET + "There was an error in one of the bot's files! (info.json) ")
        print(Fore.LIGHTRED_EX + f'\n {e}')
        exit(1)
...
async def event_ready():
    os.system('cls||clear')
    print(intro)
    print(Fore.LIGHTYELLOW_EX + '[PEELYBOT] ' + Fore.RESET + 'LobbyBot Ready As ' + Fore.LIGHTGREEN_EX + f'{client.user.display_name}')
    print(Fore.LIGHTGREEN_EX + f'{client.user.id}')
